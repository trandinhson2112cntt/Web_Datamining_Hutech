...
[assembly: OwinStartup(typeof(Web_Datamining.Web.App_Start.Startup))]

namespace Web_Datamining.Web.App_Start
{
    public class Startup
    {
        ...
        private void ConfigAutofac(IAppBuilder app)
        {
            ...
            builder.RegisterType<WebDbContext>().AsSelf().InstancePerRequest();
            ...
            //Repositories
            builder.RegisterAssemblyTypes(typeof(LuatRepository).Assembly)
